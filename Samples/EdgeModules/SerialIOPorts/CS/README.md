...
This sample demonstrates how to create a module for Azure IoT Edge on Windows 10 IoT Enterprise to communicate with peripherals connected via the serial bus.
