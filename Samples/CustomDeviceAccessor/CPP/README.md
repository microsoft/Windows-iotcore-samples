...
If you now run `mincomm -list`, you should see ACPI\PNP0501\1 in the list of COM ports. Mincomm is available [here](https://github.com/ms-iot/samples/tree/develop/MinComm).
